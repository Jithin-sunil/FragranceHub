...
import 'package:user/components/colors.dart';
import 'package:user/components/form_validation.dart';
import 'package:user/screens/homepage.dart'; // Replace with your perfume home screen
        ...
        body: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color.fromARGB(255, 161, 97, 45), // Light lavender
                Color.fromARGB(216, 233, 172, 81), // Soft purple
                Color.fromARGB(255, 95, 70, 16), // Off-white
              ],
            ),
          ),
          child: SafeArea(
  ...
  Future<void> login() async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const HomeScreen()), // Update to your perfume home screen
      );
    } catch (e) {
  ...
  Future<void> storeData(String uid) async {
    try {
      await supabase.from("tbl_user").insert({
        ...
        'user_password': _passController.text, // Note: Avoid storing passwords in plaintext
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text("Welcome to FragranceHub! Registration Successful"),
        backgroundColor: Color.fromARGB(255, 140, 179, 248),
      ));
    } catch (e) {
