    ...
    setState(() {
      filteredItems = items.where((item) {
        ...
        bool matchesSearch = searchQuery.isEmpty || 
            item['tbl_product']['product_name'].toString().toLowerCase().contains(searchQuery.toLowerCase());
        
        // Filter by category
        bool matchesCategory = selectedCategoryId == null || 
            item['tbl_product']['tbl_subcategory']['category_id'] == selectedCategoryId;
        
        // Filter by subcategory
        bool matchesSubcategory = selectedSubcategoryId == null || 
            item['tbl_product']['subcategory_id'] == selectedSubcategoryId;
                    ...
                    children: [
                      ...
                      DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            if (value == 'price_asc') {
                              filteredItems.sort((a, b) => (a['tbl_product']['product_price'] as num).compareTo(b['tbl_product']['product_price'] as num));
                            } else if (value == 'price_desc') {
                              filteredItems.sort((a, b) => (b['tbl_product']['product_price'] as num).compareTo(a['tbl_product']['product_price'] as num));
                            } else if (value == 'name_asc') {
                              filteredItems.sort((a, b) => a['tbl_product']['product_name'].toString().compareTo(b['tbl_product']['product_name'].toString()));
                            }
                          });
                        },
                      ),
                  ...
                  child: filteredItems.isEmpty
                      ...
                      : GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            print("Image: ${item['tbl_product']}");
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ProductPage(productId: item['tbl_product']['product_id']),
                                  ),
                                );
                              },
                              child: Container(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: NetworkImage(item['tbl_product']['product_image']),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 4),
                                          Text(
                                            '₹${item['tbl_product']['product_price']}',
                                            style: TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.bold,
                                              color: Color(0xFF64B5F6),
